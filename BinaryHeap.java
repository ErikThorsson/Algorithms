...
/*
 * Help and some source code taken from http://www.sanfoundry.com/java-program-implement-binary-heap/
 */
...
public class BinaryHeap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        b.insert(new Vertex(1,8));
        b.insert(new Vertex(1,1));
        b.insert(new Vertex(1,3));
        b.insert(new Vertex(1,15));
        b.insert(new Vertex(1,5));
